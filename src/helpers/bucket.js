...
var paintBucketApp = (function(canvas, canvasWidth, canvasHeight) {
    "use strict";
    ...
    var context,
            ...
            $("#canvas").mousedown(function(e) {
                ...
                if (mouseX < drawingAreaX) {
                    ...
                    if (mouseX > swatchStartX) {
                        if (
                            mouseY > swatchStartY &&
                            mouseY < swatchStartY + swatchImageHeight
                        ) {
                            curColor = colorPurple;
                            redraw();
                        } else if (
                            mouseY > swatchStartY + swatchImageHeight &&
                            mouseY < swatchStartY + swatchImageHeight * 2
                        ) {
                            curColor = colorGreen;
                            redraw();
                        } else if (
                            mouseY > swatchStartY + swatchImageHeight * 2 &&
                            mouseY < swatchStartY + swatchImageHeight * 3
                        ) {
        ...
        init = function() {
            ...
            outlineImage.onload = function() {
                ...
                try {
                    outlineLayerData = context.getImageData(
                        0,
                        0,
                        canvasWidth,
                        canvasHeight
